/*
 *	Rule.h - defines the display of the rule page 
 */
...
Rule::Rule() : menu(700, 550){
		bgImg.Decode("rules/Rule_bgd.png");
		bgImg.Flip();
		menu.SetText("Menu");
}

void Rule::FillBackground()const{
